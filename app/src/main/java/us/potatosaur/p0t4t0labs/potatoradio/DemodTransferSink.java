...
import com.mantz_it.rfanalyzer.FirFilter;
...
public class DemodTransferSink extends Thread {
    ...
    private static final String LOGTAG = "DemodTransferSink";
     ...
     */
    public DemodTransferSink (int packetSize, int sampleRate) {
